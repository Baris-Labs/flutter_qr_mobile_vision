...
class Barcode {
  ...
  factory Barcode.fromJson(Map<String, dynamic> json) {
    return Barcode(
      ...
      boundingBox: Rect.fromLTRB(double.parse(json['left'].toString()), double.parse(json['top'].toString()), double.parse(json['right'].toString()), double.parse(json['bottom'].toString())),
